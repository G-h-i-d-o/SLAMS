...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { to: "/users",          label: "Users",           icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">{icon.users}</svg>, adminOnly: true },
      { to: "/import-history", label: "Import History",  icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">{icon.download}</svg>, adminOnly: true },
      { to: "/audit",          label: "Audit Log",       icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">{icon.shield}</svg>, adminOnly: true },
    ],
  },
];
